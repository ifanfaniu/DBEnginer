...
public class RealmStorage: LocalStorage {
    ...
    public func registerStorables( _ version: UInt64, _ storables: StorableBase.Type...) {
        ...
        let config = Realm.Configuration(fileURL: URL(fileURLWithPath: RLMRealmPathForFile("realm_gg_water_mark.realm")),
